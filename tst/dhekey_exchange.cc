...
const char client_ramdom[] = "64:3e:fb:44:58:18:b5:50:62:36:f5:2e:c9:61:52:9b:7c:55:24:45:03:23:b6:0a:99:d5:3e:f7:89:ae:23:13";
...
TEST_CASE("cert") {
	...
	auto [K, e] = process_bitstring(jv[0][0][6][1].asString());//asString remove " ";
	DiffieHellman<128> diffie;
	diffie.p = cc2z(p);
	diffie.g = cc2z(g);
	diffie.ya = cc2z(ya);
	diffie.yb_ = cc2z(yb);
	auto m = cc2z(sign);
	auto hash = powm(m, e, K);
	cout << endl << "hash : " << hash;
}
